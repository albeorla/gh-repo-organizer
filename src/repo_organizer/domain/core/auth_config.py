...
def is_authentication_required(operation_name: str, config: Optional[AuthConfig] = None) -> bool:
    """
...
def get_operations_requiring_auth(config: Optional[AuthConfig] = None) -> Set[str]:
    """
