...
from repo_organizer.domain.core.auth_config import AuthConfig, get_default_config, is_authentication_required
...
class AuthService:
    ...
    def validate_operation(self, operation_name: str, username: Optional[str] = None) -> Tuple[bool, Optional[str]]:
        """
        ...
        if not validation_result.is_valid:
            return False, f"Authentication required for '{operation_name}': {validation_result.error_message}"
        
        # Username is valid and operation is authenticated
        return True, None
    
    def is_operation_allowed(self, operation_name: str, username: Optional[str] = None) -> bool:
        """
