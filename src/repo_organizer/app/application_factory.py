...
class ApplicationFactory:
    ...
    def create_application(
        ...
        if output_dir:
            ...
            expanded_output = os.path.abspath(os.path.expanduser(os.path.expandvars(output_dir)))
        ...
        logger = Logger(log_file, console, debug_enabled=settings.debug_logging, quiet_mode=quiet_mode)
