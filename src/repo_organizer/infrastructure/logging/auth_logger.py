...
class AuthLogger:
    ...
    def log_authentication_attempt(
        ...
        ip_address = os.environ.get('REMOTE_ADDR', 'localhost')  # Will be localhost for CLI usage
        ...
        if self.logger:
            ...
            self.logger.log(f"Authentication {status}: {user_str} - {operation_name}", level=level)