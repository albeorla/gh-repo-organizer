...
from repo_organizer.domain.core.auth_config import AuthConfig
...
def authenticate_command(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        if typer_callback:
            wrapper.__typer_callback__ = typer_callback
...
def validate_command_auth(
    ...
    # Log the authentication attempt
    metadata = {"command": command_name, "validation_type": "standalone"}
