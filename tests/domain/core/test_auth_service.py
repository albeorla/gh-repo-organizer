...
class TestAuthService:
    ...
    def test_validate_operation_requiring_auth(self):
        ...
        is_valid, error_message = auth_service.validate_operation("test_operation", "valid-user")
        assert is_valid is True
        assert error_message is None
    ...
    def test_validate_operation_with_invalid_usernames(self):
        ...
        is_valid, error_message = auth_service.validate_operation("any_operation", "user@domain")
        assert is_valid is False
